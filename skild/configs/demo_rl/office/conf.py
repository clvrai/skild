...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill_prior/office/office_prior"),
)
...
hl_policy_params = AttrDict(
    ...
    posterior_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill_posterior/office/office_post"),
)
...
hl_agent_config.update(AttrDict(
    ...
    discriminator_checkpoint=os.path.join(os.environ["EXP_DIR"], "demo_discriminator/office/office_discr"),
    ...
    expert_data_path=os.path.join(os.environ['DATA_DIR'], 'office_demos'),
))
