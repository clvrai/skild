...
demo_data_config.dataset_spec.n_seqs = 5           # number of demos used
demo_data_config.dataset_spec.seq_repeat = 30      # repeat those demos N times
model_config.demo_data_conf = demo_data_config
model_config.demo_data_path = os.path.join(os.environ['DATA_DIR'], 'maze_demos')
